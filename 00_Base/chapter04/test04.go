...
func getSum0(n1 int, n2 int) int {
	return n1 + n2
}
...
//支持对函数返回值命名
func getSumAndSub0(n1 int, n2 int) (sum int, sub int){
	sub = n1 - n2
	sum = n1 + n2
	return
}
...
func main() {
	...
	//看案例
	res3 := myFun2(getSum0, 500, 600)
	fmt.Println("res3=", res3)


	//看案例
	a1, b1 := getSumAndSub0(1, 2)
	fmt.Printf("a=%v b=%v\n", a1, b1)
